...
//    List<String> VoucherHdr_list =new ArrayList<>() ;
    ...
    List<Map<String,String>> VoucherHeader;
...
//            for (int j = i; j <= i; j += 4) {
             ...
             ItemHeader_DAO.addItemHeader(new ItemsInOutH(hdr.get("Vserial"), hdr.get("TransNum"), hdr.get("TransCode"), hdr.get("TransDate"), "", 0));
//            }
        }
...
//                           i.putExtra("Details", (Serializable) SelectedDetails);
                ...
                } else Toast.makeText(ReadVoucher_Activity.this, "No Voucher selected", Toast.LENGTH_SHORT).show();

            } else Toast.makeText(ReadVoucher_Activity.this, "No Voucher founded", Toast.LENGTH_SHORT).show();
        }
    }
    @Override
    public void onStart(){
